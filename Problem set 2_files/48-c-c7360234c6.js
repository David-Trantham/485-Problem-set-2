...
var l=o.n(c)
var a=o("v0Tn")
const i=l.a.shape,_=l.a.string,n=l.a.arrayOf,r=l.a.oneOf,s=l.a.bool,u=l.a.instanceOf
const k={}
k.migrationState=r(a["a"].statesList)
k.term=i({id:_.isRequired,name:_.isRequired})
k.termList=n(k.term)
k.account=i({id:_.isRequired,name:_.isRequired})
k.accountList=n(k.account)
k.course=i({id:_.isRequired,name:_.isRequired,course_code:_.isRequired,term:k.term.isRequired,teachers:n(i({display_name:_.isRequired})),teacher_count:_,sis_course_id:_})
k.courseList=n(k.course)
k.courseInfo=i({id:_.isRequired,name:_.isRequired,enrollment_term_id:_.isRequired,sis_course_id:_})
k.lockableAttribute=r(["points","content","due_dates","availability_dates","settings","deleted"])
k.lockableAttributeList=n(k.lockableAttribute)
k.migrationException=i({course_id:_.isRequired,conflicting_changes:k.lockableAttributeList})
k.migrationExceptionList=n(k.migrationException)
k.migrationChange=i({asset_id:_.isRequired,asset_type:r(["assignment","quiz","discussion_topic","wiki_page","attachment","context_module","learning_outcome","learning_outcome_group","announcement","rubric","syllabus"]).isRequired,asset_name:_.isRequired,change_type:r(["created","updated","deleted"]).isRequired,htnl_url:_,exceptions:k.migrationExceptionList})
k.migrationChangeList=n(k.migrationChange)
k.migration=i({id:_.isRequired,workflow_state:k.migrationState.isRequired,comment:_,created_at:_.isRequired,exports_started_at:_,imports_queued_at:_,imports_completed_at:_,changes:k.migrationChangeList})
k.migrationList=n(k.migration)
k.unsyncedChange=i({asset_id:_.isRequired,asset_type:_.isRequired,asset_name:_.isRequired,change_type:_.isRequired,html_url:_.isRequired,locked:s.isRequired})
k.unsyncedChanges=n(k.unsyncedChange)
k.notification=i({id:_.isRequired,message:_.isRequired,err:u(Error)})
k.notificationList=n(k.notification)
...
var B=o("o/ft")
var E=o("kC3k")
const S={ADMIN_LOCKED:{label:w.t("Locked"),icon:B["a"],tooltip:w.t("Unlock"),variant:"primary"},ADMIN_UNLOCKED:{label:w.t("Blueprint"),icon:E["a"],tooltip:w.t("Lock"),variant:"default"},ADMIN_WILLUNLOCK:{label:w.t("Blueprint"),icon:E["a"],tooltip:w.t("Unlock"),variant:"default"},ADMIN_WILLLOCK:{label:w.t("Locked"),icon:B["a"],tooltip:w.t("Lock"),variant:"primary"},TEACH_LOCKED:{label:w.t("Locked"),icon:B["a"]},TEACH_UNLOCKED:{label:w.t("Blueprint"),icon:E["a"]}}
...
this.onEnter=()=>{this.props.isToggleable&&this.setState({mode:this.props.isLocked?S.ADMIN_WILLUNLOCK:S.ADMIN_WILLLOCK})}
this.onExit=()=>{this.props.isToggleable&&this.setState({mode:this.props.isLocked?S.ADMIN_LOCKED:S.ADMIN_UNLOCKED})}
this.state={}
e.isToggleable?this.state.mode=e.isLocked?S.ADMIN_LOCKED:S.ADMIN_UNLOCKED:this.state.mode=e.isLocked?S.TEACH_LOCKED:S.TEACH_UNLOCKED}render(){const e=this.state.mode.icon
...
o=Object(c["a"])(O["a"],{tip:a,placement:"top",variant:"inverse",on:["hover","focus"]},void 0,Object(c["a"])(q["a"],{variant:l,onClick:this.props.onClick,onFocus:this.onEnter,onBlur:this.onExit,onMouseEnter:this.onEnter,onMouseLeave:this.onExit,"aria-pressed":this.props.isLocked},void 0,Object(c["a"])(e,{}),Object(c["a"])(A["a"],{},void 0,t),Object(c["a"])(j["a"],{},void 0,i)))}else o=Object(c["a"])("span",{className:"bpc__lock-no__toggle"},void 0,Object(c["a"])("span",{className:"bpc__lock-no__toggle-icon"},void 0,Object(c["a"])(e,{})),Object(c["a"])(L["a"],{size:"small"},void 0,t))
...
this.setupToggle(()=>{k.a.render(Object(c["a"])(I,{isLocked:this.state.isLocked,isToggleable:"show"===this.props.page&&this.state.isMasterContent,onClick:this.toggleLocked}),this.toggleNode)})}renderBanner(){this.bannerNode||(this.bannerNode=C.setupRootNode())
...
//# sourceMappingURL=48-c-c7360234c6.js.map
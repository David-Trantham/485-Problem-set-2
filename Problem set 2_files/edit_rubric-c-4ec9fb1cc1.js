(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[363,663,673,686,687,744],{"/iD7":function(e,t,n){"use strict"
var o=n("pQTu")
var a=n("m0r6")
...
n("jQeR")
n("0sPK")
var i=o["default"].scoped("editor.keyboard_shortcuts")
var r=n("ouhR")
var s=n.n(r)
var l=n("FIFq")
var c=n.n(l)
...
p[g]=h((function(e,t,n,o,a){this.compilerInfo=[4,">= 1.0.0"]
n=this.merge(n,e.helpers)
a=a||{}
var i,r="",s="function",l=this.escapeExpression,c=this
function d(e,t){var o,a,i=""
i+="\n    <li>\n      <code>"
if(a=n.key)o=a.call(e,{hash:{},data:t})
else{a=e&&e.key
o=typeof a===s?a.call(e,{hash:{},data:t}):a}i+=l(o)+"</code>\n      <span>"
if(a=n.description)o=a.call(e,{hash:{},data:t})
else{a=e&&e.description
o=typeof a===s?a.call(e,{hash:{},data:t}):a}i+=l(o)+"</span>\n    </li>\n  "
return i}r+='<ul class="tinymce-keyboard-shortcuts">\n  '
i=n.each.call(t,t&&t.keybindings,{hash:{},inverse:c.noop,fn:c.program(1,d,a),data:a});(i||0===i)&&(r+=i)
r+="\n</ul>\n"
return r}))
...
return r.join("\n")},delimit:function(e){var t,n,o,a,i
...
n=Math.floor(n/1e3)
a=o+a}return i+String(n)+a},truncateText:function(e,t){var n,o,a,i,r,l
null==t&&(t={})
o=null!=(i=t.max)?i:30
n=s.t("ellipsis","...")
...
var U=(k=Object(g["a"])("7.0.0",null,"Use Text from ui-text instead."),j=Object(p["j"])(v,O),k(w=j(w=(B=x=function(e){Object(l["a"])(t,e)
function t(){Object(a["a"])(this,t)
return Object(r["a"])(this,Object(s["a"])(t).apply(this,arguments))}Object(i["a"])(t,[{key:"render",value:function(){var e
var n=this.props,a=n.wrap,i=n.weight,r=n.fontStyle,s=n.size,l=n.lineHeight,c=n.letterSpacing,u=n.transform,b=n.color,_=n.children
var p=Object(f["a"])(t,this.props)
return d.a.createElement(p,Object.assign({},Object(m["a"])(this.props,t.propTypes),{className:h()((e={},Object(o["a"])(e,O.root,true),Object(o["a"])(e,O[s],s),Object(o["a"])(e,O["wrap-".concat(a)],a),Object(o["a"])(e,O["weight-".concat(i)],i),Object(o["a"])(e,O["style-".concat(r)],r),Object(o["a"])(e,O["transform-".concat(u)],u),Object(o["a"])(e,O["lineHeight-".concat(l)],l),Object(o["a"])(e,O["letterSpacing-".concat(c)],c),Object(o["a"])(e,O["color-".concat(b)],b),e)),ref:this.props.elementRef}),_)}}])
t.displayName="Text"
...
let o=n.offset(),i=n.outerWidth(),r=n.outerHeight(),s=o.top,l=s+r,c=o.left,d=c+i,u="html,body"==this.selector?a.a.windowScrollTop():this.scrollTop(),b=this.scrollLeft(),_=this.outerHeight(),h=this.outerWidth()
...
l-=e.top
c-=e.left
d-=e.left}if("HTML"==this[0].tagName||"BODY"==this[0].tagName){_=a()(window).height()
a()("#wizard_box:visible").length>0&&(_-=a()("#wizard_box:visible").height())
h=a()(window).width()
s-=u
c-=b
l-=u
d-=b}s<0||_<r&&l>_?t.scrollTop=s+u:l>_&&(t.scrollTop=l+u-_+20)
...
return a.a.isArray(t)?t.map(e=>u(this.name,e)):u(this.name,t)}a.a.fn.serializeForm=function(){return this.map(c).filter(d).map(b).get()}},"EvX+":function(e,t,n){"use strict"
var o=n("HIhM")
const a={}
...
const a=o?"no_variables":i.getCssVariant()
return[window.ENV.ASSET_HOST||"","dist","brandable_css",a,"".concat(e,"-").concat(n,".css")].join("/")},loadStylesheet(e,t){if(e in a)return
...
var a=Object(c["a"])(e),i=Object(o["a"])(a,2),r=i[0],s=i[1]
return"rem"===s?r*l():"em"===s?r*l(n):r}},HbFp:function(e,t,n){"use strict"
var o=n("qJBq")
var a=n.n(o)
var i=n("pQTu")
const r={_parseNumber:a.a,parse(e){if(null==e)return NaN
if("number"===typeof e)return e
let t=r._parseNumber(e.toString(),{thousands:i["default"].lookup("number.format.delimiter"),decimal:i["default"].lookup("number.format.separator")})
...
a.a.isReady?i():a()(document).ready(()=>i())},TBRb:function(e,t,n){"use strict"
var o=n("ouhR")
var a=n.n(o)
var i=n("GLiE")
var r=n.n(i)
...
return{text:n.text(),"data-text-while-loading":n.data("textWhileLoading"),click:()=>n.click(),class:o,id:i}})
...
var A=(O=Object(g["a"])("7.0.0",{label:"renderLabel",required:"isRequired",inline:"display"}),U=Object(x["j"])(B,S),O(z=U(z=(q=C=function(e){Object(s["a"])(n,e)
var t=Object(l["a"])(n)
function n(e){var o
Object(i["a"])(this,n)
o=t.call(this)
...
o._defaultId=Object(w["a"])("TextInput")
o._messagesId=Object(w["a"])("TextInput-messages")
return o}Object(r["a"])(n,[{key:"focus",value:function(){this._input.focus()}},{key:"renderInput",value:function(){var e
var t=this.props,n=t.type,i=t.size,r=t.htmlSize,s=(t.display,t.textAlign),l=t.placeholder,c=t.value,u=t.defaultValue,b=t.required,_=t.isRequired,p=Object(a["a"])(t,["type","size","htmlSize","display","textAlign","placeholder","value","defaultValue","required","isRequired"])
var g=Object(f["b"])(p)
var m=this.interaction
var y=(e={},Object(o["a"])(e,S.input,true),Object(o["a"])(e,S[i],i),Object(o["a"])(e,S["textAlign--".concat(s)],s),e)
var v=""
g["aria-describedby"]&&(v="".concat(g["aria-describedby"]))
this.hasMessages&&(v=""!==v?"".concat(v," ").concat(this._messagesId):this._messagesId)
return d.a.createElement("input",Object.assign({},g,{className:h()(y),defaultValue:u,value:c,placeholder:l,ref:this.handleInputRef,type:n,id:this.id,required:_||b,"aria-invalid":this.invalid?"true":null,disabled:"disabled"===m,readOnly:"readonly"===m,"aria-describedby":""!==v?v:null,size:r,onChange:this.handleChange,onBlur:this.handleBlur,onFocus:this.handleFocus}))}},{key:"render",value:function(){var e
var t=this.props,n=t.width,a=t.inline,i=t.display,r=t.label,s=t.renderLabel,l=t.renderBeforeInput,c=t.renderAfterInput,u=t.messages,b=t.inputContainerRef,_=t.icon,p=t.shouldNotWrap
var g=this.interaction
var f=l||c||_
var y=(e={},Object(o["a"])(e,S.facade,true),Object(o["a"])(e,S.disabled,"disabled"===g),Object(o["a"])(e,S.invalid,this.invalid),Object(o["a"])(e,S.focused,this.state.hasFocus),e)
return d.a.createElement(k["a"],{id:this.id,label:Object(m["a"])(s||r),messagesId:this._messagesId,messages:u,inline:"inline-block"===i||a,width:n,inputContainerRef:b,layout:this.props.layout},d.a.createElement("span",{className:h()(y)},f?d.a.createElement(j["a"],{wrap:p?"no-wrap":"wrap"},l&&d.a.createElement(j["a"].Item,{padding:"0 0 0 small"},Object(m["a"])(l)),d.a.createElement(j["a"].Item,{shouldGrow:true,shouldShrink:true},d.a.createElement(j["a"],{__dangerouslyIgnoreExperimentalWarnings:true},d.a.createElement(j["a"].Item,{shouldGrow:true,shouldShrink:true},this.renderInput()),(c||_)&&d.a.createElement(j["a"].Item,{padding:"0 small 0 0"},c?Object(m["a"])(c):Object(m["a"])(_))))):this.renderInput()))}},{key:"interaction",get:function(){return Object(y["a"])({props:this.props})}},{key:"hasMessages",get:function(){return this.props.messages&&this.props.messages.length>0}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}},{key:"focused",get:function(){return Object(v["a"])(this._input)}},{key:"value",get:function(){return this._input.value}},{key:"id",get:function(){return this.props.id||this._defaultId}}])
n.displayName="TextInput"
return n}(c["Component"]),C.propTypes={renderLabel:b.a.oneOfType([b.a.node,b.a.func]),type:b.a.oneOf(["text","email","url","tel","search","password"]),id:b.a.string,value:Object(p["a"])(b.a.string),defaultValue:b.a.string,interaction:b.a.oneOf(["enabled","disabled","readonly"]),messages:b.a.arrayOf(k["e"].message),size:b.a.oneOf(["small","medium","large"]),textAlign:b.a.oneOf(["start","center"]),width:b.a.string,htmlSize:b.a.oneOfType([b.a.string,b.a.number]),display:b.a.oneOf(["inline-block","block"]),shouldNotWrap:b.a.bool,placeholder:b.a.string,isRequired:b.a.bool,inputRef:b.a.func,inputContainerRef:b.a.func,renderBeforeInput:b.a.oneOfType([b.a.node,b.a.func]),renderAfterInput:b.a.oneOfType([b.a.node,b.a.func]),onChange:b.a.func,onBlur:b.a.func,onFocus:b.a.func,icon:b.a.func,label:b.a.oneOfType([b.a.node,b.a.func]),required:b.a.bool,inline:b.a.bool},C.defaultProps={renderLabel:void 0,type:"text",id:void 0,interaction:void 0,isRequired:false,value:void 0,defaultValue:void 0,display:"block",shouldNotWrap:false,placeholder:void 0,width:void 0,size:"medium",htmlSize:void 0,textAlign:"start",messages:[],inputRef:function(e){},inputContainerRef:function(e){},onChange:function(e,t){},onBlur:function(e){},onFocus:function(e){},renderBeforeInput:void 0,renderAfterInput:void 0},q))||z)||z)},cClk:function(e,t,n){"use strict"
...
return function(o,a,i){var r=e.apply(null,arguments)
if(r)return r
if(o[a]&&"function"!==typeof o[t])return new Error(["You provided a '".concat(a,"' prop without an '").concat(t,"' handler on '").concat(i,"'. This will render a controlled component. If the component should be uncontrolled and manage its own state, use '").concat(n,"'. Otherwise, set '").concat(t,"'.")].join(""))}}},cbNQ:function(e,t,n){"use strict"
n.d(t,"a",(function(){return a}))
...
function _(){return document.getElementById("flash_screenreader_holder")}function h(e){let t=e.label,n=e.closeButtonLabel,i=e.onDismiss,c=e.children,d=Object(a["a"])(e,["label","closeButtonLabel","onDismiss","children"])
return r.a.createElement(b["a"],Object.assign({liveRegion:_},d,{label:t,onDismiss:i}),Object(o["a"])(b["a"].Header,{},void 0,Object(o["a"])(s["a"],{"data-testid":"instui-modal-close",placement:"end",offset:"medium",onClick:i},void 0,n||u.t("Close")),Object(o["a"])(l["a"],{},void 0,t)),c)}["Header","Body","Footer"].forEach(e=>h[e]=b["a"][e])
...
o=a=void 0
s=t
if(true!==c){i=e.apply(r,n)
return i}}function p(e){s=e
l.push(setTimeout(m,t))
return d?h(e):i}function g(e){var n=e-r
var o=e-s
var a=t-n
return u?Math.min(a,_-o):a}function f(e){var n=e-r
var o=e-s
return"undefined"===typeof r||n>=t||n<0||u&&o>=_}function m(){var e=Date.now()
if(f(e))return y(e)
l.push(setTimeout(m,g(e)))}function y(e){j()
if(b&&o)return h(e)
o=a=void 0
return i}function v(){c=true
j()
s=0
o=r=a=void 0}function k(){return 0===l.length?i:y(Date.now())}function j(){l.forEach((function(e){return clearTimeout(e)}))
...
return h(r)}}0===l.length&&l.push(setTimeout(m,t))
return i}w.cancel=v
w.flush=k
...
n("Z+Ib")
n("JI1W")
t["a"]={fieldSelectors:null,findSiblingTinymce:function(e){return e.siblings(".mce-tinymce").find(".mce-edit-area")},findField:function(e,t){var n,o,i
null==t&&(t=false)
i=(null!=(o=this.fieldSelectors)?o[e]:void 0)||"[name='"+e+"']"
n=t?a()(i):this.$(i)
n.data("rich_text")&&(n=this.findSiblingTinymce(n))
return n},showErrors:function(e,t){var n,o,i,r,l,c,d,u
null==t&&(t=false)
u=[]
for(i in e){o=e[i]
n=o.element||this.findField(i,t)
r=o.message||function(){var e,t,n,a
a=[]
...
null!=(c=n.errorBox(a.a.raw(""+r)))&&null!=(d=c.css("z-index","1100"))&&d.attr("role","alert")
...
var n=this.props,i=n.border,r=n.children,s=n.color,l=n.level,c=n.margin,d=n.elementRef,b=n.ellipsis,_=Object(a["a"])(n,["border","children","color","level","margin","elementRef","ellipsis"])
var h=Object(v["a"])(t,this.props,(function(){return"reset"===l?"span":l}))
return u.a.createElement(g["a"],Object.assign({},Object(k["b"])(_),{className:p()((e={},Object(o["a"])(e,A.root,true),Object(o["a"])(e,A["level--".concat(l)],true),Object(o["a"])(e,A["color--".concat(s)],s),Object(o["a"])(e,A["border--".concat(i)],"none"!==i),Object(o["a"])(e,A.ellipsis,b),e)),as:h,margin:c,elementRef:d}),r)}}])
t.displayName="Heading"
return t}(d["Component"]),q.propTypes={border:_.a.oneOf(["none","top","bottom"]),children:m["a"],color:_.a.oneOf(["primary","secondary","primary-inverse","secondary-inverse","inherit"]),level:_.a.oneOf(["h1","h2","h3","h4","h5","reset"]),as:_.a.elementType,margin:f["c"].spacing,elementRef:_.a.func,ellipsis:_.a.bool},q.defaultProps={children:null,margin:void 0,elementRef:void 0,border:"none",color:"inherit",level:"h2"},S))||C)||C)||C)},mykf:function(e,t,n){"use strict"
...
n("jQeR")
n("0sPK")
var i=o["default"].scoped("instructure_misc_plugins")
var r=n("ouhR")
var s=n.n(r)
var l=n("5Ky4")
var c=n("JD5e")
...
s.a.ajaxJSON(e.url,"DELETE",o,n=>{e.success.call(t,n)},(n,o,a,i)=>{e.error&&s.a.isFunction(e.error)?e.error.call(t,n,o,a,i):s.a.ajaxJSON.unhandledXHRs.push(o)})}else{e.success||(e.success=function(){t.fadeOut("slow",()=>{t.remove()})})
e.success.call(t)}}
...
n=s()(e.message).dialog(s.a.extend({},{modal:true,close:a,buttons:[{text:i.t("#buttons.cancel","Cancel"),click(){s()(this).dialog("close")}},{text:i.t("#buttons.delete","Delete"),class:r,click(){o=true
...
t.css({width:o+6,height:a+6,top:n.top-3,left:n.left-3,zIndex:i+1,position:"absolute",display:"block","-moz-border-radius":5,opacity:.8,border:"2px solid #870",backgroundColor:"#fd0"})
...
return this}
s.a.fn.fillWindowWithMe=function(e){const t=s.a.extend({minHeight:400},e),n=s()(this),o=s()("#wrapper"),a=s()("#main"),i=s()("#not_right_side"),r=s()(window),l=s()(this).add(t.alsoResize)
function c(){l.height(0)
const e=r.height()-(o.offset().top+o.outerHeight())+(a.height()-i.height()),c=Math.max(400,e)
l.height(c)
...
const u={translateMathmlForScreenreaders(e){const t=a()("<div/>").html(e.attr("x-canvaslms-safe-mathml")).html()
...
o=[]
t={}
e.exports=n=function(e,n,a){var i,r,s,l,c,d,u,b,_
null==a&&(a=true)
...
_=n[0],i=n[1]}else if(Array.isArray(n)){if(2!==n.length)throw{name:"ArgumentException",message:"The format for array options is ['<thousands>','[<decimal>'] (exactly two elements)"}
_=n[0],i=n[1]}else{_=(null!=n?n.thousands:void 0)||(null!=n?n.group:void 0)||t.thousands
i=(null!=n?n.decimal:void 0)||t.decimal}u=""+_+i+a
d=o[u]
if(null==d){s=a?3:1
d=o[u]=new RegExp("^\\s*([+-]?(?:(?:\\d{1,3}(?:\\"+_+"\\d{"+s+",3})+)|\\d*))(?:\\"+i+"(\\d*))?\\s*$")}b=e.match(d)
...
let t,o=this.name.match(i.key),s=this.value,l=this.name
while(void 0!==(t=o.pop())){l=l.replace(new RegExp("\\["+t+"\\]$"),"")
if(t.match(i.push))s=r([],n(l),s)
else if(t.match(i.fixed)){n(l,t)
s=r([],t,s)}else t.match(i.named)&&(s=r({},t,s))}e=a.a.extend(true,e,s)}))
...
s.bind(e,n)}
o.unsubscribe=i=function(){s.unbind.apply(s,arguments)}
o.publish=r=function(){s.trigger.apply(s,arguments)}
e.exports={subscribe:a,unsubscribe:i,publish:r}}}])

//# sourceMappingURL=edit_rubric-c-4ec9fb1cc1.js.map
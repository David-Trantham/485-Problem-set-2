...
const l=Object(d["lazy"])(()=>Promise.all([t.e(6),t.e(7),t.e(9),t.e(154),t.e(691)]).then(t.bind(null,"mftS")))
...
return _.a.createElement(i["a"],Object.assign({label:c.t("Copy To..."),placement:"end",onDismiss:s,padding:"medium"},o),Object(a["a"])(l,{sourceCourseId:n,contentSelection:t,onCancel:s}))}},U6jy:function(e,n){e.exports=a
...
function y(e){let n=e.padding,t=e.headerPadding,s=e.contentPadding,o=e.errorSubject,d=e.errorCategory,p=e.errorImageUrl,v=e.label,y=e.title,m=e.onDismiss,j=e.children,k=Object(r["a"])(e,["padding","headerPadding","contentPadding","errorSubject","errorCategory","errorImageUrl","label","title","onDismiss","children"])
null==t&&(t="0 0 ".concat(n," 0"))
null==y&&(y=v)
var S=Object(a["a"])(b["a"].Item,{grow:true},void 0,Object(a["a"])(u["a"],{ellipsis:true},void 0,y))
function C(){return Object(a["a"])(b["a"],{as:"div",padding:t},void 0,S,Object(a["a"])(b["a"].Item,{},void 0,Object(a["a"])(i["a"],{onClick:m,size:"small"},void 0,c.t("Close"))))}var O=Object(a["a"])(f["a"],{imageUrl:p,errorSubject:o,errorCategory:d})
var A=Object(a["a"])(l["a"],{as:"div",padding:s,width:"100%",height:"100%"},void 0,j)
function x(){return Object(a["a"])(h["a"],{errorComponent:O},void 0,A)}return _.a.createElement(g["a"],Object.assign({label:v,onDismiss:m},k),Object(a["a"])(l["a"],{as:"div",padding:n,position:"absolute",insetBlockStart:"0",insetBlockEnd:"0",insetInlineStart:"0",insetInlineEnd:"0"},void 0,Object(a["a"])("div",{style:{display:"flex",flexDirection:"column",width:"100%",height:"100%"}},void 0,C(),Object(a["a"])("div",{style:{position:"relative",flex:1}},void 0,x()))))}},ppA4:function(e,n,t){"use strict"
var a=t("An8g")
var r=t("VTBJ")
var s=t("ODXe")
var o=t("Ff2n")
...
const y=Object(i["lazy"])(()=>Promise.all([t.e(6),t.e(7),t.e(9),t.e(662)]).then(t.bind(null,"FB/m")))
function m(e){let n=e.contentShare,t=e.courseId,c=Object(o["a"])(e,["contentShare","courseId"])
const d=Object(i["useState"])([]),m=Object(s["a"])(d,2),j=m[0],k=m[1]
const S=Object(i["useState"])(null),C=Object(s["a"])(S,2),O=C[0],A=C[1]
const x=Object(i["useRef"])(c.open)
function E(){k([])
A(null)}function L(e){j.find(n=>n.id===e.id)||k(j.concat([e]))}function z(e){k(j.filter(n=>n.id!==e.id))}function T(){return Object(v["a"])({method:"POST",path:"/api/v1/users/self/content_shares",body:Object(r["a"])({},n,{receiver_ids:j.map(e=>e.id)})})}function I(){A("info")
T().then(w).catch(e=>{console.error(e)
e.response&&console.error(e.response)
A("error")})}function w(){Object(p["c"])(_.t("Content share started successfully"))()
c.onDismiss()}function B(){return l.a.createElement(l.a.Fragment,null,Object(a["a"])(u["a"],{onClick:c.onDismiss},void 0,_.t("Cancel")),Object(a["a"])(u["a"],{disabled:0===j.length||"info"===O,variant:"primary",margin:"0 0 0 x-small",onClick:I},void 0,_.t("Send")))}const R=Object(a["a"])(h["a"],{as:"div",textAlign:"center"},void 0,Object(a["a"])(g["a"],{renderTitle:_.t("Loading")}))
if(c.open!==x.current){x.current=c.open
E()}let K=""
"info"===O?K=_.t("Starting content share"):"error"===O&&(K=_.t("Error starting content share"))
const F=K?Object(a["a"])(b["a"],{variant:O},void 0,Object(a["a"])("div",{role:"alert","aria-live":"assertive","aria-atomic":true},void 0,K),"info"===O?Object(a["a"])(g["a"],{renderTitle:K,size:"x-small"}):null):null
return l.a.createElement(f["a"],Object.assign({label:_.t("Send To..."),size:"medium"},c,{footer:Object(a["a"])(B,{})}),Object(a["a"])(i["Suspense"],{fallback:R},void 0,F,Object(a["a"])(y,{courseId:t,selectedUsers:j,onUserSelected:L,onUserRemoved:z})))}},qBwj:function(e,n,t){"use strict"
var a=t("17x9")
var r=t("EUQ6")
...
//# sourceMappingURL=40-c-9d325b1c8d.js.map
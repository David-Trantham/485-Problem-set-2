(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[136],{"+Qka":function(e,t,a){var r=a("fmRc"),n=a("t2Dn"),i=a("cq/+"),o=a("T1AV"),s=a("GoyQ"),_=a("mTTR"),l=a("itsj")
...
return e}()
function z(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}function A(e,t){return t={exports:{}},e(t,t.exports),t.exports}function C(e){return e&&e.default||e}var T=A((function(e,t){Object.defineProperty(t,"__esModule",{value:true})
t.default=a
...
var Ae={plugins:[q,D,H,V,G,Z,Q,$,te,re,ie,se,le,de,we],prefixMap:{transform:Se,transformOrigin:Se,transformOriginX:Se,transformOriginY:Se,backfaceVisibility:ye,perspective:ye,perspectiveOrigin:ye,transformStyle:ye,transformOriginZ:ye,animation:ye,animationDelay:ye,animationDirection:ye,animationFillMode:ye,animationDuration:ye,animationIterationCount:ye,animationName:ye,animationPlayState:ye,animationTimingFunction:ye,appearance:Oe,userSelect:ze,fontKerning:ye,textEmphasisPosition:ye,textEmphasis:ye,textEmphasisStyle:ye,textEmphasisColor:ye,boxDecorationBreak:ye,clipPath:ye,maskImage:ye,maskMode:ye,maskRepeat:ye,maskPosition:ye,maskClip:ye,maskOrigin:ye,maskSize:ye,maskComposite:ye,mask:ye,maskBorderSource:ye,maskBorderMode:ye,maskBorderSlice:ye,maskBorderWidth:ye,maskBorderOutset:ye,maskBorderRepeat:ye,maskBorder:ye,maskType:ye,textDecorationStyle:Oe,textDecorationSkip:Oe,textDecorationLine:Oe,textDecorationColor:Oe,filter:ye,fontFeatureSettings:Oe,breakAfter:ze,breakBefore:ze,breakInside:ze,columnCount:Oe,columnFill:Oe,columnGap:Oe,columnRule:Oe,columnRuleColor:Oe,columnRuleStyle:Oe,columnRuleWidth:Oe,columns:Oe,columnSpan:Oe,columnWidth:Oe,writingMode:Se,flex:Se,flexBasis:ye,flexDirection:Se,flexGrow:ye,flexFlow:Se,flexShrink:ye,flexWrap:Se,alignContent:ye,alignItems:ye,alignSelf:ye,justifyContent:ye,order:ye,transitionDelay:ye,transitionDuration:ye,transitionProperty:ye,transitionTimingFunction:ye,backdropFilter:ye,scrollSnapType:Se,scrollSnapPointsX:Se,scrollSnapPointsY:Se,scrollSnapDestination:Se,scrollSnapCoordinate:Se,shapeImageThreshold:ye,shapeImageMargin:ye,shapeImageOutside:ye,hyphens:ze,flowInto:Se,flowFrom:Se,regionFragment:Se,textOrientation:ye,boxSizing:xe,textAlignLast:xe,tabSize:xe,wrapFlow:je,wrapThrough:je,wrapMargin:je,touchAction:je,textSizeAdjust:Se,borderImage:ye,borderImageOutset:ye,borderImageRepeat:ye,borderImageSlice:ye,borderImageSource:ye,borderImageWidth:ye}}
var Ce=N(Ae)
...
t.keyOrder.splice(c,0,s[_])}else t.keyOrder.unshift(s[_])}var d=false===r?k:w
var u=[]
...
return et(e,r,t)},flushToStyleTag:Ze,injectAndGetClassName:et,defaultSelectorHandlers:Te,reset:Ue,resetInjectedStyle:Ve}}a.d(t,"StyleSheet",(function(){return ct}))
...
var y={}
_&&(y.onMouseOver=w)
return i.default.createElement("div",r({style:g.swatch,onClick:v,title:d,tabIndex:0,onKeyDown:k},y),f,p&&i.default.createElement(c.default,{borderRadius:g.swatch.borderRadius,boxShadow:"inset 0 0 0 1px rgba(0,0,0,0.1)"}))}
...
ue[t]=ue[e]}))}))
var he=/([A-Z])/g,be=/^ms-/,me=n.Children.toArray,pe=w.ReactCurrentDispatcher,ge={listing:!0,pre:!0,textarea:!0},ve=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,ke={},we={}
...
var p,g,v,k,w,y
var x=(p=Object(f["a"])("7.0.0",null,"Use Spinner from ui-spinner instead."),g=Object(b["a"])(),v=Object(h["j"])(m),p(k=g(k=v(k=(y=w=function(e){Object(s["a"])(t,e)
...
var E=(j=Object(g["a"])("7.0.0",null,"Use TextInput from ui-text-input instead."),O=Object(y["a"])(),S=Object(w["j"])(x,T),j(z=O(z=S(z=(C=A=function(e){Object(_["a"])(t,e)
function t(e){var a
Object(n["a"])(this,t)
...
return"function"===typeof e?c.a.createElement("span",{className:T.icon,"aria-hidden":"true"},c.a.createElement(e,null)):null}},{key:"render",value:function(){var e
...
var ke=a.n(ve)
const we=3
function ye(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:ke.a
...
return{width:o.width,height:o.height,left:n.left+o.left,top:n.top+o.top}}function xe(){Array.from(document.querySelectorAll(".a11y-checker-selection-indicator")).forEach(e=>{e.parentNode.removeChild(e)})}function je(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:we
xe()
...
if(null==t)return
t.scrollIntoView()
a(e,t)}function Te(e,t){e.childNodes.length>0?e.insertBefore(t,e.childNodes[0]):e.appendChild(t)}function Ee(e,t){const a=e.ownerDocument.createElement(t)
...
return t.some(e=>e.nodeType===Node.TEXT_NODE)}var qe={id:"img-alt",test:e=>{if("IMG"!==e.tagName)return true
...
a("x1Tw")
const Fe=/^\S+\.\S+$/
var Be={id:"img-alt-filename",test:e=>!Fe.test(e.getAttribute("alt")),data:e=>{const t=e.getAttribute("alt")
...
Te(e,a)}a.textContent=t.caption
...
const wt=e=>"P"===e.tagName&&kt.test(e.textContent)
const yt=e=>{if(e.nodeType===Node.TEXT_NODE){e.textContent=e.textContent.replace(kt,"")
return true}for(let t of e.childNodes){let e=yt(t)
...
var Ot={id:"list-structure",test:function(e){const t=wt(e)
const a=!e.previousElementSibling||!wt(e.previousElementSibling)
...
var St=[qe,Be,De,He,Ve,Xe,Ze,at,dt,ft,mt,Ot]
const zt=()=>{}
...
o.a.render(n.a.createElement(At,{getBody:e.getBody.bind(e),editor:e}),Et,(function(){Ct=this
Tt.forEach(e=>e(Ct))
Ct.check(...a)}))}))
...
function Mt(e){if(null!=Ct)return e(Ct)
Tt.push(e)}function Lt(e){const t=he.setup()
t.locale=e
he.setup(t)}var Pt=a("DSFK")
var Rt=a("25BE")
var Nt=a("BsWD")
var It=a("PYwp")
function qt(e){return Object(Pt["a"])(e)||Object(Rt["a"])(e)||Object(Nt["a"])(e)||Object(It["a"])()}const Ft=()=>{}
function Bt(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:Ft
const a=Array.from(e.dom.doc.styleSheets),r=qt(a),n=(r[0],r.slice(1))
...
t()}Mt(e=>e.setConfig({beforeCheck:Bt,afterCheck:Dt}))
...
var k=a("J2CL")
var w=a("oXx0")
var y,x,j,O,S,z,A,C,T,E,M,L,P,R
var N=(y=Object(w["a"])(),y(x=(O=j=function(e){Object(o["a"])(a,e)
var t=Object(s["a"])(a)
function a(){Object(i["a"])(this,a)
return t.apply(this,arguments)}return a}(g["a"]),j.displayName="PopoverTrigger",O))||x)
var I=(S=Object(w["a"])(),S(z=(C=A=function(e){Object(o["a"])(a,e)
var t=Object(s["a"])(a)
function a(){Object(i["a"])(this,a)
return t.apply(this,arguments)}return a}(g["a"]),A.displayName="PopoverContent",C))||z)
var q=(T=Object(v["a"])("7.0.0",null,"Use Popover from ui-popover instead."),E=Object(w["a"])(),M=Object(h["a"])(),T(L=E(L=M(L=(R=P=function(e){Object(o["a"])(a,e)
var t=Object(s["a"])(a)
function a(){var e
Object(i["a"])(this,a)
